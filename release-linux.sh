...
echo "      Sandbox: --sandbox microsandbox uses KVM (/dev/kvm). The standalone"
echo "      binary inherits your user's access; for AppImage use ensure the AppImage"
echo "      process is in the 'kvm' group so /dev/kvm is readable+writable. See"
echo "      docs/guides/sandbox.md. No Docker/Podman/Firejail/msb required."
